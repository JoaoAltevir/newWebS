...
curl_setopt($ch, CURLOPT_URL, 'http://jsuol.com.br/c/monaco/utils/gestor/commons.js?file=commons.uol.com.br/sistemas/esporte/modalidades/futebol/campeonatos/dados/2025/30/dados.json');
$tabela = curl_exec($ch);
curl_close($ch);
